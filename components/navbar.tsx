			...
			<NavigationMenu>
				<NavigationMenuList>
					<NavigationMenuLink asChild>
						<Link href='/docs' legacyBehavior passHref>
							<NavigationMenuLink className={navigationMenuTriggerStyle()}>
								<Image src='/hourglass.svg' alt='Hourglass Logo' height={24} width={24} priority />
							</NavigationMenuLink>
						</Link>
					</NavigationMenuLink>
					...
					<NavigationMenuItem>
						...
						<NavigationMenuContent>
							<ul className='grid gap-1 p-4 md:w-[250px]'>
								{projects?.map((project) => (
									<ListItem key={project.id} href={`/${org_id}/projects/${project.id}`} title={project.name}>
										Software Project
									</ListItem>
								))}
								<Separator />
								<ListItem href={`${org_id}/projects`} title='View All Projects' />
								<ListItem href={`${org_id}/projects/new`} title='Create Project' />
							</ul>
						</NavigationMenuContent>
					</NavigationMenuItem>
